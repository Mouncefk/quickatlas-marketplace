...
async function handleRequest(req, res) {
  ...
  try {
    ...
    if (pathname === '/api/listings/promo' && method === 'GET') {
      const row = db
        .prepare(
          `SELECT l.id, l.title, l.listing_type, l.price, l.currency, l.images_json, l.boosted_until, l.view_count, l.is_secondhand, l.date_start, l.date_end, l.price_promo, l.price_type, l.capacity_guests, l.capacity_children, l.bedrooms, l.bathrooms, l.amenities_json, l.activity_duration, l.activity_group_size_min, l.activity_group_size_max, l.activity_languages, l.activity_meeting_point, l.activity_difficulty, l.activity_min_age, l.vehicle_brand, l.vehicle_model, l.vehicle_year, l.vehicle_mileage, l.vehicle_condition, l.vehicle_transmission, l.vehicle_fuel_type, l.surface_m2, l.num_rooms, l.floor_number, l.furnished, l.construction_year, l.job_contract_type, l.job_remote_type, l.job_experience_level, l.job_education_level, l.job_sector, l.job_cv_url, l.is_demo, l.transaction_completed, l.created_at, l.expires_at,
                  cat.slug AS category_slug, cat.name AS category_name, cat.icon AS category_icon,
    ...
    if ((m = pathname.match(/^\/api\/listings\/(\d+)\/similar$/)) && method === 'GET') {
      ...
      const rows = db
        .prepare(
          `SELECT l.id, l.title, l.listing_type, l.price, l.currency, l.images_json, l.boosted_until, l.is_secondhand, l.date_start, l.date_end, l.price_promo, l.price_type, l.capacity_guests, l.capacity_children, l.bedrooms, l.bathrooms, l.amenities_json, l.activity_duration, l.activity_group_size_min, l.activity_group_size_max, l.activity_languages, l.activity_meeting_point, l.activity_difficulty, l.activity_min_age, l.vehicle_brand, l.vehicle_model, l.vehicle_year, l.vehicle_mileage, l.vehicle_condition, l.vehicle_transmission, l.vehicle_fuel_type, l.surface_m2, l.num_rooms, l.floor_number, l.furnished, l.construction_year, l.job_contract_type, l.job_remote_type, l.job_experience_level, l.job_education_level, l.job_sector, l.job_cv_url, l.is_demo, l.transaction_completed, l.created_at, l.expires_at,
                  cat.slug AS category_slug, cat.name AS category_name, cat.icon AS category_icon,
    ...
    if ((m = pathname.match(/^\/api\/listings\/(\d+)$/)) && (method === 'PUT' || method === 'DELETE')) {
      ...
      const fields = ['title', 'description', 'listing_type', 'price', 'currency', 'city_id', 'category_id', 'subcategory_id', 'status', 'visible_all_cities', 'capacity_guests', 'capacity_children', 'bedrooms', 'bathrooms', 'activity_duration', 'activity_group_size_min', 'activity_group_size_max', 'activity_languages', 'activity_meeting_point', 'activity_difficulty', 'activity_min_age'];
      const updates = [];
      const params = [];
      ...
      const rows = db
        .prepare(
          `SELECT l.id, l.title, l.listing_type, l.price, l.currency, l.status, l.images_json, l.created_at,
                  l.expires_at, l.boosted_until, l.view_count, l.is_secondhand, l.date_start, l.date_end, l.price_promo, l.price_type, l.capacity_guests, l.capacity_children, l.bedrooms, l.bathrooms, l.amenities_json, l.activity_duration, l.activity_group_size_min, l.activity_group_size_max, l.activity_languages, l.activity_meeting_point, l.activity_difficulty, l.activity_min_age, l.vehicle_brand, l.vehicle_model, l.vehicle_year, l.vehicle_mileage, l.vehicle_condition, l.vehicle_transmission, l.vehicle_fuel_type, l.surface_m2, l.num_rooms, l.floor_number, l.furnished, l.construction_year, l.job_contract_type, l.job_remote_type, l.job_experience_level, l.job_education_level, l.job_sector, l.job_cv_url, l.is_demo, l.transaction_completed, l.created_at,
    ...
    if (pathname === '/api/admin/listings' && method === 'GET') {
      ...
      const rows = db
        .prepare(
          `SELECT l.id, l.title, l.listing_type, l.price, l.currency, l.status, l.created_at, l.is_secondhand, l.date_start, l.date_end, l.price_promo, l.price_type, l.capacity_guests, l.capacity_children, l.bedrooms, l.bathrooms, l.amenities_json, l.activity_duration, l.activity_group_size_min, l.activity_group_size_max, l.activity_languages, l.activity_meeting_point, l.activity_difficulty, l.activity_min_age, l.vehicle_brand, l.vehicle_model, l.vehicle_year, l.vehicle_mileage, l.vehicle_condition, l.vehicle_transmission, l.vehicle_fuel_type, l.surface_m2, l.num_rooms, l.floor_number, l.furnished, l.construction_year, l.job_contract_type, l.job_remote_type, l.job_experience_level, l.job_education_level, l.job_sector, l.job_cv_url, l.is_demo, l.transaction_completed, l.expires_at,
...
if (pathname === '/api/super-admin/plans' && method === 'GET') {
    ...
    if (pathname === '/api/business-opportunities' && method === 'GET') {
      ...
      const listings = db
        .prepare(
          `SELECT l.id, l.title, l.listing_type, l.price, l.currency, l.images_json, l.is_secondhand, l.date_start, l.date_end, l.price_promo, l.price_type, l.capacity_guests, l.capacity_children, l.bedrooms, l.bathrooms, l.amenities_json, l.activity_duration, l.activity_group_size_min, l.activity_group_size_max, l.activity_languages, l.activity_meeting_point, l.activity_difficulty, l.activity_min_age, l.vehicle_brand, l.vehicle_model, l.vehicle_year, l.vehicle_mileage, l.vehicle_condition, l.vehicle_transmission, l.vehicle_fuel_type, l.surface_m2, l.num_rooms, l.floor_number, l.furnished, l.construction_year, l.job_contract_type, l.job_remote_type, l.job_experience_level, l.job_education_level, l.job_sector, l.job_cv_url, l.is_demo, l.transaction_completed, l.created_at, l.expires_at,
                  sub.slug AS subcategory_slug, sub.name AS subcategory_name,
                  ci.name AS city_name, co.iso2 AS country_iso2, co.name AS country_name
           FROM listings l
           JOIN categories cat ON cat.id = l.category_id
    ...
    if (pathname === '/api/favorites' && method === 'GET') {
      ...
      const rows = db
        .prepare(
          `SELECT l.id, l.title, l.listing_type, l.price, l.currency, l.images_json, l.boosted_until, l.created_at, l.view_count, l.is_secondhand, l.date_start, l.date_end, l.price_promo, l.price_type, l.capacity_guests, l.capacity_children, l.bedrooms, l.bathrooms, l.amenities_json, l.activity_duration, l.activity_group_size_min, l.activity_group_size_max, l.activity_languages, l.activity_meeting_point, l.activity_difficulty, l.activity_min_age, l.vehicle_brand, l.vehicle_model, l.vehicle_year, l.vehicle_mileage, l.vehicle_condition, l.vehicle_transmission, l.vehicle_fuel_type, l.surface_m2, l.num_rooms, l.floor_number, l.furnished, l.construction_year, l.job_contract_type, l.job_remote_type, l.job_experience_level, l.job_education_level, l.job_sector, l.job_cv_url, l.is_demo, l.transaction_completed, l.expires_at,
                  cat.slug AS category_slug, cat.name AS category_name, cat.icon AS category_icon,
                  sub.slug AS subcategory_slug, sub.name AS subcategory_name,
                  ci.name AS city_name, co.iso2 AS country_iso2, co.name AS country_name
           FROM favorites f
