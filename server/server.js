...
async function handleRequest(req, res) {
  ...
  if (!pathname.startsWith('/api/')) {
    ...
    // Documents publics (dossier de présentation PDF, plaquettes...) —
    // servis directement par serveStatic() via public/documents/, comme
    // n'importe quel autre fichier du dépôt (logo, etc.). Pas besoin
    // d'une route dédiée : déposer le fichier dans ce dossier et le
    // pousser sur GitHub suffit, exactement comme pour tout autre
    // fichier statique du site.
